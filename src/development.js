...
class DevelopmentComponents extends React.Component {
    constructor (props){
      super(props)
      this.state = ({
...
type Props = {};
export default class development extends Component<Props> {
  constructor (props){
    super(props)
    this.state = ({
      W: Dimensions.get('window').width,
      ...
      db.transaction((tx) => {
        tx.executeSql('SELECT * FROM developments', [], (tx, results) => {
